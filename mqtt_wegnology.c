...
void on_message(struct mosquitto *mosq, void *obj, const struct mosquitto_message *msg){
	...
	if(strstr(comando,"comando_solar2022")!=NULL){
		...
		// printf("recebi comando temp_nivel_solar2022\n");
